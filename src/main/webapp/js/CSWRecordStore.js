...
Ext.extend(CSWRecordStore, Ext.data.GroupingStore, {
    ...
    createAdHocCSWRecord : function(endpoint, layerName, type) {
        var data  = {
            success : true,
            records : [{
                'serviceName' : 'TODO-ReplaceMe',
                'contactOrganisation' : 'TODO-ReplaceMe',
                'resourceProvider' : 'TODO-ReplaceMe',
                'fileIdentifier' : 'TODO-FakeID',
                'recordInfoUrl' : 'TODO-ReplaceMe',
                'dataIdentificationAbstract' : 'TODO-ReplaceMe',
                'onlineResources' : [{
                    url : endpoint,
                ...
                'descriptiveKeywords' : 'TODO-ReplaceMe',
                'geographicElements' : [],
                'constraints' : []
            }]
        };

        CSWRecordStore.superclass.loadData.call(this, data, true);

        var dataRecord = this.getById('TODO-FakeID');
        return new CSWRecord(dataRecord);
    }
